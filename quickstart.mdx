...
Include the Dark-RP Framework files in your map project. The framework handles all core systems, so no additional plugins are required.
...
- Salary or resource gain
- Appearance models
- Custom abilities or restrictions
